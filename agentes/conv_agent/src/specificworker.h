...
#include "/home/robocomp/robocomp/components/dsr-graph/etc/graph_names.h"
...
private:
    ...
    void insert_action_edge(int action);
	void remove_intention_edge(string action);
	void remove_intention_node();

    // Node
    DSR::Node ready_person;
};
