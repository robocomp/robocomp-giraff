...
/** \mainpage RoboComp::path_follower_mpc
 *
 * \section intro_sec Introduction
 *
 * The path_follower_mpc component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/path_follower_mpc --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class path_follower_mpc : public RoboComp::Application
{
public:
	path_follower_mpc (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::path_follower_mpc::initialize()
{
...
int ::path_follower_mpc::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::path_follower_mpc app(prefix, startup_check_flag);
