...
void SpecificWorker::initialize(int period)
{
    ...
    {
        // MPC
        mpc.initialize_differential(consts.num_steps_mpc);
...
RoboCompLaser::TLaserData SpecificWorker::read_laser(bool noise)
{
    ...
    static std::normal_distribution<double> normal_dist(0.0, consts.lidar_noise_sigma);
