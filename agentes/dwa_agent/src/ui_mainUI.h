...
public:
    ...
    void setupUi(QWidget *guiDlg)
    {
        ...
        centralwidget->setGeometry(QRect(0, 0, 2, 12));
        ...
        graphicsView->setGeometry(QRect(30, 50, 531, 481));
    ...
    {
        guiDlg->setWindowTitle(QApplication::translate("guiDlg", "dwa_agent", nullptr));
