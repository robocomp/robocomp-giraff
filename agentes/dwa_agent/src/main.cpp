...
/** \mainpage RoboComp::dwa_agent
 *
 * \section intro_sec Introduction
 *
 * The dwa_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/dwa_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class dwa_agent : public RoboComp::Application
{
public:
	dwa_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::dwa_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::dwa_agent app(prefix, startup_check_flag);
