...
/** \mainpage RoboComp::human_observer
 *
 * \section intro_sec Introduction
 *
 * The human_observer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/human_observer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class human_observer : public RoboComp::Application
{
public:
	human_observer (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::human_observer::initialize()
{
...
int ::human_observer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::human_observer app(prefix, startup_check_flag);
