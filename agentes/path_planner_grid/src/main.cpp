...
/** \mainpage RoboComp::path_planner_grid
 *
 * \section intro_sec Introduction
 *
 * The path_planner_grid component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/path_planner_grid --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class path_planner_grid : public RoboComp::Application
{
public:
	path_planner_grid (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::path_planner_grid::initialize()
{
...
int ::path_planner_grid::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::path_planner_grid app(prefix, startup_check_flag);
