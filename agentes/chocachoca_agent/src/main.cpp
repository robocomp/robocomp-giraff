...
/** \mainpage RoboComp::chocachoca_agent
 *
 * \section intro_sec Introduction
 *
 * The chocachoca_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/chocachoca_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class chocachoca_agent : public RoboComp::Application
{
public:
	chocachoca_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::chocachoca_agent::initialize()
{
...
int ::chocachoca_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::chocachoca_agent app(prefix, startup_check_flag);
