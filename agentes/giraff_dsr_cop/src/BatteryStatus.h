...
struct TBattery
{
     ...
     * @return The data members in a tuple.
     */
    std::tuple<const float&, const ::RoboCompBatteryStatus::BatteryStates&, const float&, const float&> ice_tuple() const
    {
        return std::tie(percentage, state, voltage, current);
    }
};
...
public:
    ...
    {
        return _makeLamdaOutgoing<::RoboCompBatteryStatus::TBattery>(response, ex, sent, this, &RoboCompBatteryStatus::BatteryStatusPrx::_iceI_getBatteryState, context);
    }
...
struct StreamReader<::RoboCompBatteryStatus::TBattery, S>
{
    ...
    {
        istr->readAll(v.percentage, v.state, v.voltage, v.current);
    }
};
