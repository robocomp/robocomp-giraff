 ...
 *
 * Just: "${PATH_TO_BINARY}/mapper --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class mapper : public RoboComp::Application
{
public:
	mapper (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::mapper::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::mapper app(prefix, startup_check_flag);
