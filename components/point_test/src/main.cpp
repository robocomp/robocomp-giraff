...
int ::local_grid::run(int argc, char* argv[])
{
	...
	tprx = std::make_tuple(billcoppelia_proxy,camerargbdsimple_proxy,camerasimple_proxy,differentialrobot_proxy,fullposeestimation_proxy,jointmotorsimple_proxy,laser_proxy,pathsmoother_proxy);
